      ...
      {(screenWidth > 768) &&(
        <>
              ...
              <ol className='navBar__social-list'>
                <li className='navBar__social-list-item'><a className='navBar__social-list-item-link' title='linkedin' target={`_blank`} href="https://www.linkedin.com/feed/"><BrandLinkedin size={48} strokeWidth={2} color={'#F5F5F5'}/>LinkedIn</a></li>
                <li className='navBar__social-list-item'><a className='navBar__social-list-item-link' title='github' target={`_blank`} href="https://github.com/Luagir94">< BrandGithub size={48} strokeWidth={2} color={'#F5F5F5'}/>GitHub</a></li>
                <li className='navBar__social-list-item'><a className='navBar__social-list-item-link' title='twitter' target={`_blank`} href="https://twitter.com/home"><  BrandTwitter size={48} strokeWidth={2} color={'#F5F5F5'}/>Twitter</a></li>
